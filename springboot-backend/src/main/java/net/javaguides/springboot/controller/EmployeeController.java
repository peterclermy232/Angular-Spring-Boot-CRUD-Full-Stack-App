...
public class EmployeeController {
	...
	public ResponseEntity<?> createEmployee(@RequestBody Map<String, Object> employeeData) {
		...
		if (!employeeData.containsKey("firstName") ||
				!employeeData.containsKey("lastName") ||
				!employeeData.containsKey("emailId")) {
			return ResponseEntity.badRequest().body("Error: Missing required keys. 'firstName', 'lastName', and 'emailId' are required.");
		}
		...
		employee.setEmailId((String) employeeData.get("emailId"));
